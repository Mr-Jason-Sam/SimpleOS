...
int Lmachine::getint(MemoryNode mem)
{
    ...
    if (mem.value=='a') {
        ...
        if(is_symbol(num))
            number=getsymbol(num)->integer_value;
        else
...
bool Lmachine::init()
{
    ...
    infile = "/home/jason/Desktop/Operating_Systems/heart_parsing_code.txt";
...
//    cout<<"output file path and name:";
    //cin>>outfile;
    outfile = "/home/jason/Desktop/Operating_Systems/heart_parsing.txt";
    if(outfile=="null")
    {
        return true;
    }
    else
    {
        ...
        newfilepath.open(string2char(outfile));
        if(newfilepath)
        {
    ...
    while(getline(code,line))
    {
        ...
        while (index<length) {
            ...
            if (line[index]>='0'&&line[index]<='9') {
                ...
                ast_codestream.push_back(token);
            }
            //id
        ...
        if (command.value=='o') {
            ...
            switch (index) {
                ...
                case OPINIT:
                {
                    ...
                    MemoryNode reg=Memory[lvmcpu.pc];
                    int regindex=getregindex(reg);
                    lvm_symbol *sym=getsymbol(var_name);
                    if(sym->define==true)
                    {
                    ...
                    else
                    {
                        ...
                        sym->integer_value=num;
                        sym->type=integer_var;
                        sym->define=true;
                    }
                    break;
                }
                ...
                case OPASSIGN:
                {
                    ...
                    if (variable.value=='a') {
                        ...
                        var_name=getstring(variable);
                    lvm_symbol *var_sym=getsymbol(var_name);
                    lvmcpu.pc++;
                    ...
                    if (assign_value.value=='a') {
                        ...
                        assign_name=getstring(assign_value);
                    lvm_symbol *assign_sym=getsymbol(assign_name);
                    //register
                    if(assign_value.value=='r')
                    {
                        ...
                        else //number
                        {
                            int num;
                            regoperand(regindex, assign, num, parastr);
                            if(var_sym->type==integer_array)
                                var_sym->array_value[index]=num;
                            else
                            {
                                var_sym->integer_value=num;
                                var_sym->type=integer_var;
                            }
                        }
                    }
                    //value
                    else
                    {
                        ...
                        {
                            if(assign_sym->type==integer_var)
                            {
                                if (var_sym->type==integer_array) {
                                    var_sym->array_value[var_index]=assign_sym->integer_value;
                                }
                                else
                                {
                                    var_sym->integer_value=assign_sym->integer_value;
                                    var_sym->type=integer_var;
                                }
                            }
                            else if(assign_sym->type==integer_var)
                            {
                                var_sym->integer_value=assign_sym->integer_value;
                                var_sym->type=integer_var;
                            }
                        ...
                        {
                            lvm_symbol *strassign=getsymbol(assign_name);
                            if (variable.value=='a') {
                                var_sym->array_value[var_index]=strassign->array_value[assign_index];
                            }
                            else
                            {
                                var_sym->integer_value=strassign->array_value[assign_index];
                                var_sym->type=integer_var;
                            }
                        }
                    }
                ...
                case OPBINADD:
                {
                    ...
                    lvm_symbol *savesym=getsymbol(strsave);
                    lvmcpu.pc++;
                    ...
                    if (add1.value=='v')
                    {
                        ...
                        add1num=getsymbol(stradd1)->integer_value;
                    }
                    else
                        add1num=getint(add1);
                    lvmcpu.pc++;
                    ...
                    if (add2.value=='v') {
                        ...
                        add2num=getsymbol(stradd2)->integer_value;
                    }
                    else
                        add2num=getint(add2);
                    int savenum=add1num+add2num;
                    savesym->integer_value=savenum;
                    savesym->type=integer_var;
                    break;
                }
                case OPADDB:
                {
                ...
                case OPBINSUB:
                {
                    ...
                    if (sub1.value=='v')
                    {
                        ...
                        sub1num=getsymbol(strsub1)->integer_value;
                    }
                    else
                        sub1num=getint(sub1);
                    lvmcpu.pc++;
                    ...
                    if (sub2.value=='v') {
                        ...
                        sub2num=getsymbol(strsub2)->integer_value;
                    }
                    else
                        sub2num=getint(sub2);
                ...
                case OPBINMUL:
                {
                    ...
                    if (mul1.value=='v')
                    {
                        ...
                        mul1num=getsymbol(strmul1)->integer_value;
                    }
                    else
                        mul1num=getint(mul1);
                    lvmcpu.pc++;
                    ...
                    if (mul2.value=='v') {
                        ...
                        mul2num=getsymbol(strmul2)->integer_value;
                    }
                    else
                        mul2num=getint(mul2);
                ...
                case OPJG:
                {
                    ...
                    else
                    {
                        ...
                        lvm_symbol *sym=getsymbol(symbolname);
                        cmp1num=sym->integer_value;
                    }
                    lvmcpu.pc++;
                ...
                case OPJNG:
                {
                    ...
                    MemoryNode addr_label=Memory[lvmcpu.pc];
                    string strlabel=getstring(addr_label);
                    lvm_symbol *label_sym=getsymbol(strlabel);
